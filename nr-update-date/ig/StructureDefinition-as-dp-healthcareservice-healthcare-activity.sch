...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:HealthcareService/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'dateUpdateAuthorization']) &lt;= 0">extension with URL = 'dateUpdateAuthorization': maximum cardinality of 'extension' is 0</sch:assert>
